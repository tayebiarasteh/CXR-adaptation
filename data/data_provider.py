...
class vindr_data_loader_2D(Dataset):
    ...
    def __init__(self, cfg_path, mode='train', augment=False, image_size=224):
        ...
        if mode == 'train':
            ...
            self.file_base_dir = os.path.join(self.file_base_dir, 'valid')
        elif mode == 'test':
        ...
        self.chosen_labels = ['Atelectasis', 'Cardiomegaly', 'Pleural effusion', 'Pneumonia', 'No finding']
...
class chexpert_data_loader_2D(Dataset):
    ...
    def __init__(self, cfg_path, mode='train', augment=False, image_size=224):
        ...
        self.org_df = pd.read_csv(os.path.join(self.file_base_dir, "CheXpert-v1.0", "masterlist.csv"), sep=',')
...
class UKA_data_loader_2D(Dataset):
    ...
    def __init__(self, cfg_path, mode='train', augment=False, image_size=224):
        ...
        self.chosen_labels = ['atelectasis', 'cardiomegaly', 'pleural_effusion', 'pneumonic_infiltrates', 'healthy']
...
class cxr14_data_loader_2D(Dataset):
    ...
    def __init__(self, cfg_path, mode='train', augment=False, image_size=224):
        ...
        self.chosen_labels = ['atelectasis', 'cardiomegaly', 'effusion', 'pneumonia', 'no_finding']
